        ...
        def views():
            ...
            while not start_wait_for_halt.is_set():
                ...
                for j in range(N):
                    ...
                    spbc = gevent.spawn(strongprovablebroadcast,
                                        sid + 'SPBC' + str(j),
                                        pid, N, f,
                                        PK1, SK1,
                                        j,
                                ...
                                if vote_msg[1] != 1:
                                    ...
                                    try:
                                        ...
                                        assert PK1.verify_signature(
                                            vote_msg[3],
                                            _hash(str((sid + 'SPBC' + str(leader), vote_msg[2], "ECHO"))), allow_pickle=True)
                                    except AssertionError:
                            ...
                            if aba_tag == 'vote':
                                ...
                                if vote_msg[1] == 0:
                                    ...
                                    if len(vote_no_shares) == N - f:
                                        ...
                                        pis = PK1.combine_shares(vote_no_shares, allow_pickle=True)
