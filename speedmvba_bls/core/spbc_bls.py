...
def strongprovablebroadcast(sid,
                            pid, N, f,
    ...
    try:
        ...
        while True:
            ...
            if msg[0] == 'SPBC_SEND':
                ...
                send(leader, ('SPBC_ECHO', SK1.sign(digest1FromLeader, allow_pickle=True)))
                ...
                if len(cbc_echo_sshares) == EchoThreshold and not echoSent:
                    ...
                    sigmas = PK1.combine_shares(cbc_echo_sshares, allow_pickle=True)
                ...
                if len(cbc_echo_sshares2) == EchoThreshold and not finalSent:
                    ...
                    sigmas2 = PK1.combine_shares(cbc_echo_sshares2, allow_pickle=True)
